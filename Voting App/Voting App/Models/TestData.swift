...
struct TestData {
    var campaigns: [Campaign] {
        ...
        let campaign1 = Campaign(campaignName: "SGA Elections", campaignDescription: "Description", positions: [pres, vp])
        ...
        let campaign2 = Campaign(campaignName: "GT Water Polo", campaignDescription: "Description", positions: [cap, tres])
